...
| Métrique | Valeur |
|----------|--------|
| Bootstrap median | **0.720** |
| CI 95% lower | 0.495 |
| CI 95% upper | 0.856 |
| **Zone** | **GRISE** |
| **Action** | v3.11 + re-run B=4096 |

![Bootstrap histogram](bootstrap_histogram_b1024.png)
...
![Correlation plot](correlation_plot_b1024.png)
...
| Weedle | 39 | 21 | +18 | 0.0000 | 0.500 |
| Rattata | 16 | 30 | -14 | 0.0108 | 0.497 |
